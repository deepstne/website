...
> Note: These commands are limited to use on the <strong><span style="color: #00a8a8">Creative</span></strong> server only. The <strong><span style="color: #cb4335">Survival</span></strong> server has a locked gamemode and, due to the nature of the server, you cannot be invincible.
