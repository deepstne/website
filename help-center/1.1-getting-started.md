...
<div class="grid-container">
  <div class="grid grid--py-3">
    <div class="cell cell--6"><div><img src="https://darkst.one/assets/brand/full-dark.svg" style="max-width:65%;" alt="Darkstone light logo"></div></div>
    <div class="cell cell--6"><div><img src="https://darkst.one/assets/brand/full-light.svg" style="max-width:65%;" alt="Darkstone dark logo"></div></div>
  </div>
</div>
</center>
...
#### Monochrome logo
In many cases on other website, listing logos in their full color is not possible to preserve visual image. As part of our brnading kit, we offer many alternate versions in single, monochrome sets with the full wordmark and icon.
<center>
<div class="grid-container">
  <div class="grid grid--py-3">
    <div class="cell cell--3"><div><img src="https://darkst.one/assets/brand/full-white.svg" style="max-width:85%;" alt="Darkstone white logo"></div></div>
    <div class="cell cell--3"><div><img src="https://darkst.one/assets/brand/full-gray.svg" style="max-width:85%;" alt="Darkstone light gray logo"></div></div>
    <div class="cell cell--3"><div><img src="https://darkst.one/assets/brand/full-darkgray.svg" style="max-width:85%;" alt="Darkstone dark gray logo"></div></div>
    <div class="cell cell--3"><div><img src="https://darkst.one/assets/brand/full-black.svg" style="max-width:85%;" alt="Darkstone black logo"></div></div>
  </div>
</div>
</center>
<hr>
...
#### Icon
In the cases of a small area to work with, sometimes an icon is only possible to be displayed. We prefer to display the full version of the logo if possible, with the icon and wordmark. Monochrome variations of the icon are available, too.
<center>
<div class="grid-container">
  <div class="grid grid--py-3">
    <div class="cell cell--6"><div><img src="https://darkst.one/assets/brand/circles.svg" style="max-width:25%;" alt="Darkstone icon"></div></div>
    <div class="cell cell--6"><div><img src="https://darkst.one/assets/brand/circles-white.svg" style="max-width:25%;" alt="Darkstone white icon"></div></div>
  </div>
</div>
<div class="grid-container">
  <div class="grid grid--py-3">
    <div class="cell cell--3"><div><img src="https://darkst.one/assets/brand/circles-gray.svg" style="max-width:25%;" alt="Darkstone light gray icon"></div></div>
    <div class="cell cell--3"><div><img src="https://darkst.one/assets/brand/circles-darkgray.svg" style="max-width:25%;" alt="Darkstone dark gray icon"></div></div>
    <div class="cell cell--3"><div><img src="https://darkst.one/assets/brand/circles-black.svg" style="max-width:25%;" alt="Darkstone black icon"></div></div>
  </div>
</div>
</center>
<hr>
...
<div class="grid-container">
  <div class="grid grid--py-3">
    <div class="cell cell--3"><div><img src="https://darkst.one/assets/brand/mark-light.svg" style="max-width:85%;" alt="Darkstone light wordmark"></div></div>
    <div class="cell cell--3"><div><img src="https://darkst.one/assets/brand/mark-dark.svg" style="max-width:85%;" alt="Darkstone dark wordmark"></div></div>
    <div class="cell cell--3"><div><img src="https://darkst.one/assets/brand/mark-gray.svg" style="max-width:85%;" alt="Darkstone gray wordmark"></div></div>
    <div class="cell cell--3"><div><img src="https://darkst.one/assets/brand/mark-black.svg" style="max-width:85%;" alt="Darkstone black wordmark"></div></div>
  </div>
</div>
</center>
<hr>
