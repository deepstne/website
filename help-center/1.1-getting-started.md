...
<div class="grid-container">
  <div class="grid grid--py-3">
    <div class="cell cell--6"><div><img src="https://darkst.one/assets/brand/full-gray-light.svg" style="max-width:65%;" alt="Darkstone gray light logo"></div></div>
    <div class="cell cell--6"><div><img src="https://darkst.one/assets/brand/full-gray-dark.svg" style="max-width:65%;" alt="Darkstone gray dark logo"></div></div>
  </div>
</div>
</center>

### Icon
The network's icon features four circles arranged in four corners of a square. They are each colored to represent a specific server at the time of our establishment in December of 2020. 
<center>
<div class="grid-container">
  <div class="grid grid--py-3">
    <div class="cell cell--6"><div><img src="https://darkst.one/assets/brand/circles-transparent.svg" style="max-width:25%;" alt="Darkstone icon"></div></div>
    <div class="cell cell--6"><div><img src="https://darkst.one/assets/brand/circles-gray-transparent.svg" style="max-width:25%;" alt="Darkstone gray icon"></div></div>
  </div>
</div>
</center>
