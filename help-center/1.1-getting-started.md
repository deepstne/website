...
We support the latest [Minecraft Java Edition](https://www.minecraft.net/en-us/store/minecraft-java-edition) version (at the time of updating, 1.16.2) up until client 1.4.7. As the game updates, we may drop support for older client versions. For the best experience, we recommend joining with 1.16.2.
