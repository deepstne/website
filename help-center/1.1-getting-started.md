...
Once you have added the server to your list, you should be good to go! All of our players connected using Bedrock have an underscore, "_", to prevent duplicate names in Java Edition.
...
### Community forum
One of our key projects is the server's community forum and discussion platform that we host online. We make use of the [Flarum](../forum) discussion software to power our community. The forum is hosted on our [OVH](https://ovh.com) server, and no one else has access to your data.
