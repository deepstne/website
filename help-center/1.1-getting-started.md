...
<div class="grid-container">
  <div class="grid grid--py-3">
    <div class="cell cell--6"><div><img src="https://darkst.one/assets/brand/full-light.svg" style="max-width:45%;" alt="Darkstone light logo"></div></div>
    <div class="cell cell--6"><div><img src="https://darkst.one/assets/brand/full-dark.svg" style="max-width:45%;" alt="Darkstone dark logo"></div></div>
  </div>
</div>
</center>
...
<div class="grid-container">
  <div class="grid grid--py-3">
    <div class="cell cell--6"><div><img src="https://darkst.one/assets/brand/full-gray-light.svg" style="max-width:45%;" alt="Darkstone gray light logo"></div></div>
    <div class="cell cell--6"><div><img src="https://darkst.one/assets/brand/full-gray-dark.svg" style="max-width:45%;" alt="Darkstone gray dark logo"></div></div>
  </div>
</div>
<div class="grid-container">
  <div class="grid grid--py-3">
    <div class="cell cell--6"><div><img src="https://darkst.one/assets/brand/circles-transparent.svg" style="max-width:45%;" alt="Darkstone icon"></div></div>
    <div class="cell cell--6"><div><img src="https://darkst.one/assets/brand/circles-gray-transparent.svg" style="max-width:45%;" alt="Darkstone gray icon"></div></div>
  </div>
</div>
</center>
