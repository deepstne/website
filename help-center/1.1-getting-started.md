...
### Social media
We have a few accounts on social media platforms to help bring our community to new audience, and to keep our current members informed. Our [Twitter](../twitter) occasionally posts server updates and important news. We also have a [GitHub organization](../github) where we house our open-source projects and code.

### Plugin sites
Some of the plugins we run on our servers have their own websites too. The [Dynamic map](../map), a Google Maps style birds eye view of the server worlds powered by [dynmap](https://www.spigotmc.org/resources/dynmap.274/) is hosted online. This page allows real-time monitoring of players' locations in worlds for the <strong><span style="color: #00a8a8">Creative</span></strong> and <strong><span style="color: #cb4335">Survival</span></strong> servers.
...
### Community forum
We run a community forum for collaboration and official business at https://forum.darkst.one. Membership is not required to participate on the server, but recommended to dive in deeper with our community, and is required to apply for our various [titles and honors](../hc/titles-and-honors). The community forum is hosted by us and runs the [Discourse](https://www.discourse.org/) forum software.
